...
INPUT_GPKG_FILE = '{}/input-data/Firenze_land-use_CLC_WGS_84_SELECTED_10_features.gpkg'.format(ROOT)
...
INPUT_GPKG_FILE_LAYER = 'Firenze_land-use_CLC_WGS_84_SELECTED_10_features'
