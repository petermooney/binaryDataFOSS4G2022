...
INPUT_GPKG_FILE = '/home/peter/Downloads/Firenze/Firenze_land-use_CLC/Firenze_CLC.gpkg'
#INPUT_GPKG_FILE = 'test-geopackage.gpkg'
#INPUT_GPKG_FILE_LAYER = 'FI_Addresses_Sample_Aug23rd2021'

INPUT_GPKG_FILE_LAYER = 'Firenze_CLC'
...
for test in range (0,1):
    ...
    finland_gdf.to_file("/home/peter/Downloads/Firenze/Firenze_land-use_CLC/geojson-output/{}.geojson".format(file_name), driver='GeoJSON')
    ...
    file_size = os.path.getsize("/home/peter/Downloads/Firenze/Firenze_land-use_CLC/geojson-output/{}.geojson".format(file_name))
    print("GeoJSON File size is {} Kb".format(round(file_size/1024),2))
    """
    tic = time.perf_counter()
    print ("\nBegin: Loading GeoJSON file for processing...")
    geojson_data = gpd.read_file("/home/peter/Downloads/Firenze/Firenze_land-use_CLC/geojson-output/{}.geojson".format(file_name))
